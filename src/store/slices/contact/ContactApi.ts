...
// import {_apiList} from "../../../service/ListService"
...
//   const response = await fetch(_apiList);
...
//   const response = await fetch(`${_apiList}/${id}`, {
//     method: 'DELETE',
//   });
...
//   const response = await fetch(`${_apiList}/${editedContact.id}`, {
//     method: 'PUT',
//     headers: {
//       'Content-Type': 'application/json',
//     },
